# -*- coding: utf-8 -*-
"""
Created on Sat Feb 25 17:14:55 2023
...
for num in array:
    if k+i <= len(array):
        print(max(array[i:k+i]))
        i += 1 
        
# This works in O(n*k) time. This is the provided solution which is some ultra-optimized bull shit.
"""
